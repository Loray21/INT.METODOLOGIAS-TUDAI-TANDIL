<html lang="en">
    ...
    <head>
        ...
        <link
            ...
            rel="stylesheet">
        <link
            href="https://fonts.googleapis.com/css2?family=Nunito:wght@200&family=Secular+One&display=swap"
            rel="stylesheet">
        <link
            href="https://fonts.googleapis.com/css2?family=Nunito:wght@200&family=Roboto:wght@100&family=Secular+One&display=swap"
            rel="stylesheet">
        <link
            href="https://fonts.googleapis.com/css2?family=Nunito:wght@200&family=Odor+Mean+Chey&family=Roboto:wght@100&family=Secular+One&display=swap"
            rel="stylesheet">
        <link
    ...
    <body>
        <nav class="w-100">
            <div class="navbar navbar-expand-lg w-100 navbar-light bg-light
                d-flex flex-row justify-content-between">
                <div class="ms-4">
                    <img src="imagenes/logo_reciclado.png" height="128"
                        width="128">
                </div>
                <div class="w-50 me-4">
                    <ul class="navbar-nav align-items-center w-100
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-bold fs-5"
                                href="#materiales">Materiales</a>
                        </li>
                        <li class="nav-item text-align-center">
                            {if $isUserLoggedIn eq false}
                            <button type="button" class="btn btn-green
                                text-white btn-pill px-5 py-3"
                                data-bs-toggle="modal" data-bs-target="#login">
                                Log in
                            </button> {else}
                            <div class="btn-group">
                                <a class="btn stretched-link btn-red text-white
                                    btn-pill p-0 px-5 py-3"href="{BASE_URL}/logout">
                                    Log out
                                </a>
                            </div>
                            {/if}
                ...
                <div class="modal-content">
                    <div class="modal-body position-relative">
                        <div class="position-absolute top-0 end-0">
                            <button type="button" class="btn-close m-4"
                        ...
                        <div class="row px-5">
                            ...
                            <form action="login" method="POST"
                                ...
                                <button type="submit" class="btn btn-success
                                    btn-lg ms-2 mt-2 text-white">Iniciar sesión</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mt-5 pt-5 position-relative h-75 mb-5">
            <div class="row">
                <div>
                    ...
                    <p>
                        Somos una cooperativa de recicladores urbanos que lucha<br>por
                        cambiar nuestra comunidad, para dejarle<br>un mejor
                        mundo a nuestros hijos
                    </p>
                    <div class="position-absolute top-0 end-0 z-index">
                        <img src="{BASE_URL}imagenes/reciclando_1.png" alt=""
                            width="475px">
                    </div>
                </div>
            </div>
        ...
        <div class="miContainer p-4 h-75">
            <div class="row align-items-center">
                ...
                <div id="materiales" class="col-8">
                    <h1 class="text-end fs-1 font-bold"> ¿ Que material
                        aceptamos ? </h1>
        ...
        {if $isUserLoggedIn eq true}
            <div class="container">
                <div class="row mb-5">
                    <div class="col">
                        <h1 class="text-end fs-1 font-bold"> Lista de Pedidos</h1>
                        <div class="d-flex justify-content-end">
                            <div class="w-75"  id="Pedidos">
                ...
                <div class="row mb-5">
                    <div class="col">
                        <h1 class="text-end fs-1 font-bold"> Ingrese la cantidad de
                            material recolectado por un Cartonero </h1>
                        <div class="d-flex justify-content-end">
                            <div class="w-25">
                ...
                <div class="row mb-5">
                    <h1 class="text-end fs-1 font-bold"> Agregue un nuevo Cartonero a la Cooperativa </h1>
                    <div class="d-flex justify-content-end">
                        <div class="w-25">
                ...
                <div class="row">
                    <div class="col">
                        <h1 class="text-end fs-1 font-bold">Listado de materiales por cartonero</h1>
                        <div class="d-flex justify-content-end">
                            <div class="w-75">
                                <table class="table">
                                    <thead>
