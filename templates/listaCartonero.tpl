  ...
  <tbody>
    {foreach from=$cartoneros item=cartonero}
        <tr>
            ...
            {if $isUserLoggedIn == true}
                <td>
                    <a href='cartonero/{$cartonero->id_cartonero}'>
                ...
                <td>
                    <button type="button" class="editCartoneroBtn" idCartonero = {$cartonero->id_cartonero} cartoneroName = {$cartonero->nombre} cartoneroSurname = {$cartonero->apellido}
                    cartoneroDocument = {$cartonero->id_cartonero} cartoneroHorario = {$cartonero->franja_horaria_preferida} cartoneroAddress = {$cartonero->direccion} cartoneroPhone = {$cartonero->telefono}
                    cartoneroVehicle = {$cartonero->vehiculo}>
