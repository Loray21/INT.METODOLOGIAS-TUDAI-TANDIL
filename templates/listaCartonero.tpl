        ...
        <tr>
            ...
            {if $isUserLoggedIn == true}
                ...
                <td>
                    ...
                    cartoneroDocument = {$cartonero->dni} cartoneroHorario = {$cartonero->franja_horaria_preferida} cartoneroAddress = {$cartonero->direccion} cartoneroPhone = {$cartonero->telefono}
